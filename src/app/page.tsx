...
export default function Home() {
	...
	return (
		<>
			<Header />
			<div id="hero" className="relative h-screen w-screen overflow-hidden">
				<Image
			...
			<HydrateClient>
				...
				<main id="services" className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#0A2342] to-[#0A1931] text-white py-16">
				...
				<div id="alterdata" className="relative h-screen w-screen overflow-hidden bg-gradient-to-b from-[#0A2342] to-[#0A1931] text-white flex flex-col items-center justify-center p-4 md:p-8">
